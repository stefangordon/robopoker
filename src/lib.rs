...
// Real constants generated by build script
#[cfg(not(rust_analyzer))]
include!(concat!(env!("OUT_DIR"), "/lib_config.rs"));

// IDE fallback
#[cfg(rust_analyzer)]
mod _nlhe_stub {
    pub const CFR_BATCH_SIZE_NLHE: usize = 1024;
    pub const CFR_TREE_COUNT_NLHE: usize = 0x5F5E100;
    pub const RBP_WARMUP_TRAVERSALS: u64 = 0x1000000;
    // IDE-only fallback cluster counts (runtime values are generated by build.rs)
